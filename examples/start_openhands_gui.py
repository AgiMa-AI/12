...
logger = logging.getLogger("openhands_gui")
...
def start_http_server(port=8000):
    ...
    """
    server_address = ('', port)
    httpd = HTTPServer(server_address, OpenHandsHTTPHandler)
...
def main():
    """主函数。"""
    parser = argparse.ArgumentParser(description="启动OpenHands GUI界面")
...
""")
        ...
        logger.info(f"OpenHands GUI已启动，请访问 http://localhost:{args.port}")
